#!/usr/bin/env python3
"""
Machine Service Wrapper for sewing
...
class MachineService:
    ...
    def __init__(self):
        self.machine_id = os.getenv('MACHINE_ID', 'sewing-01')
        self.machine_type = os.getenv('MACHINE_TYPE', 'sewing')
